    ...
    <div className="bg-surface min-h-screen flex flex-col">
      ...
      <div className="max-w-4xl mx-auto px-4 py-24 sm:py-32 flex-1 w-full text-text">
        ...
        <div className="glass-panel p-6 sm:p-10 space-y-6 animate-slide-up leading-relaxed" style={{ animationDelay: '0.1s' }}>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">1. Order Cancellations</h2>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">2. Returns</h2>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">3. Damaged or Defective Items</h2>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">4. Refunds</h2>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">5. Contact Support</h2>
