    ...
    <div className="bg-surface min-h-screen flex flex-col">
      ...
      <div className="max-w-4xl mx-auto px-4 py-24 sm:py-32 flex-1 w-full text-text">
        ...
        <div className="glass-panel p-6 sm:p-10 space-y-6 animate-slide-up leading-relaxed" style={{ animationDelay: '0.1s' }}>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">1. General</h2>
          <p>The content of the pages of this website is for your general information and use only. It is subject to change without notice.</p>

          <h2 className="text-2xl font-bold text-text mt-8 mb-4">2. Minimum Order Value</h2>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">3. Pricing and Availability</h2>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">4. Legal Age</h2>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">5. Delivery</h2>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">6. Liability</h2>
          ...
          <h2 className="text-2xl font-bold text-text mt-8 mb-4">7. Governing Law</h2>
