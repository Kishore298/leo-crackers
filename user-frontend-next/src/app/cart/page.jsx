    ...
    <div className="bg-surface min-h-screen flex flex-col">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-32 pb-12 flex-1 w-full">
        <div className="flex items-center gap-3 mb-8">
          <Link href="/" className="text-white hover:text-primary transition bg-[#16161a] p-3 rounded-full border border-white/10">
            <FaArrowLeft />
          </Link>
        ...
        {cart.length === 0 ? (
          <div className="text-center py-24 bg-[#16161a] border border-white/5 rounded-2xl">
            ...
            <Link href="/" className="inline-block bg-gradient-to-r from-red-600 to-orange-500 text-white font-bold py-3 px-10 rounded-xl hover:shadow-[0_0_15px_rgba(255,102,0,0.4)] transition">
              Browse Products
            </Link>
          </div>
        ) : (
