          ...
          return (
            <div key={category._id} className="mb-6 glass-panel overflow-hidden animate-slide-up" style={{ animationDelay: '0.1s' }}>
              ...
              <button
                ...
                className="w-full flex items-center justify-between py-4 md:py-6 px-2 md:px-8 bg-transparent hover:opacity-80 transition-opacity"
              >
                ...
                <div className="flex flex-col gap-3">
                  {filteredProducts.map(product => {
                    ...
                    return (
                      ...
                      >
                        {/* Image */}
                        <div className="relative w-16 h-16 md:w-20 md:h-20 shrink-0 bg-[#22222a] rounded-lg overflow-visible flex items-center justify-center p-1">
                          ...
                          {product.youtubeId && (
                            <button
                              ...
                              className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity z-20 rounded-lg"
                            >
                              <FaPlayCircle className="text-2xl text-white hover:scale-110 transition-transform" />
                            </button>
                          )}
                        </div>
